-- TODO: Arquivo Criado com o objetivo de Realizar o Desafio DIO: "Personalizando o Banco de Dados com Índices e Procedures"
USE company;
SHOW TABLES;

-- adicionando o campo cidade a tabela 'departament' para a resposta de pergunta 1 do desafio 
...
/* 
	O indice escolhido foi o Btree pois ele funciona por busca binária,
	 como as cidades possuem nomes distantes(diferentes)
	 por suas inicias o algoritmo já consegue separá-las e a busca é otimizada
	 (Logicamente Árvore está balanceada)
*/

-- Query para saber qual departamento possui o maior número de funcionários (Pergunta 1)
SELECT 
...
-- Query para mostrar os departamentos por cidade (Pergunta 2)
SELECT City, Dname AS 'Department Name' FROM departament ORDER BY City;

-- Query para mostrar a Relação Empregados x Departamento (Pergunta 3)
SELECT 
...
-- Criando uma procedure para a inserção alteração ou exclusão de um funcionário (Seguindo as imposições do desafio)
DELIMITER \\
...
/*¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨¨*/
/* TODO: Adição de uma nova constraint à tabela departament, para que possa ocorrer uma exclusão em castata (Só assim podemos excluir um employee)*/
