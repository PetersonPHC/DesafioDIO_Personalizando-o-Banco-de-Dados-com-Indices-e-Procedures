...
-- TODO: pegando as informacoes das constraints do Schema do DB
SELECT * FROM information_schema.table_constraints WHERE constraint_schema = 'company';

-- TODO: Modificando uma constraint com Drop e ADD
...
-- inserindo dados (instanciando) -> adicionando Linha
